...
//
//        assertThat(httpRequest.getStartLineInfo("userId")).isEqualTo("javajigi");
//        assertThat(httpRequest.getStartLineInfo("password")).isEqualTo("password");
//        assertThat(httpRequest.getStartLineInfo("name")).isEqualTo("박재성");
//        assertThat(httpRequest.getStartLineInfo("email")).isEqualTo("javajigi@slipp.net");
//    }
